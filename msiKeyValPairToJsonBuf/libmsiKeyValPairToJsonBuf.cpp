...
int msiKeyValPairToJsonBuf(msParam_t *in, msParam_t *out, ruleExecInfo_t *rei)
{
...
extern "C" {
    ...
    irods::ms_table_entry* plugin_factory()
    {
        ...
        msvc->add_operation<msParam_t*, msParam_t*, ruleExecInfo_t*>("msiKeyValPairToJsonBuf",
                                                                     std::function<int(
                                                                         msParam_t*,
                                                                         msParam_t*,
                                                                         ruleExecInfo_t*)>
                                                                     (msiKeyValPairToJsonBuf));
